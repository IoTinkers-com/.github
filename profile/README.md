...
- 🌐 [**diy-weather-station**](https://github.com/IoTinkers-com/diy-weather-station) — DIY Weather Station prototype using ESP32-C6 and solar power measurement (`Python`)
